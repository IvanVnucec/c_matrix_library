...
/* Uncoment the lines below to implement NULL pointers or matrix dimensions check
or leave uncommented to improve execution time. */
...
enum MTX_Error_ENUM {               //!< Matrix errors
    ...
    MTX_Matrix_ERROR_ZERO_DIMS,     //!< Matrix with 0 number of rows and/or columns error
